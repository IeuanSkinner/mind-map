...
fm2_2_1_branch.child_branches.create!(name: 'FM2.2.1b', label: 'FM2.2.1b Discrete Probability Distributions')
fm2_2_1_branch.child_branches.create!(name: 'FM2.2.1c', label: 'FM2.2.1c Continuous Probability Distributions')
fm2_2_1_branch.child_branches.create!(name: 'FM2.2.1d', label: 'FM2.2.1d Poisson and exponential distributions')
...
fm2_2_2_branch.child_branches.create!(name: 'FM2.2.2a', label: 'FM2.2.2a Correlation & Goodness of fit')
