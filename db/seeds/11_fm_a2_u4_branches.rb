...
fm2_4_3_branch.child_branches.create!(name: 'FM2.4.3a', label: 'FM2.4.3a Inverse of a 3 by 3 matrix')
...
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5a', label: 'FM2.4.5a Infinite integrals')
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5b', label: 'FM2.4.5b Volumes of Revolution')
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5c', label: 'FM2.4.5c Mean value of a function')
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5d', label: 'FM2.4.5d Partial Fractions - quadratic factors')
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5e', label: 'FM2.4.5e Differentiation of Inverse trig functions')
fm2_4_5_branch.child_branches.create!(name: 'FM2.4.5f', label: 'FM2.4.5f Integrate using trig functions')

fm2_4_6_branch = fm_a2_u4_branch.child_branches.create!(name: 'FM2.4.6', label: 'FM2.4.6 Polar Coordinates')
fm2_4_6_branch.child_branches.create!(name: 'FM2.4.6a', label: 'FM2.4.6a Polar Coordinates - basics')
fm2_4_6_branch.child_branches.create!(name: 'FM2.4.6b', label: 'FM2.4.6b Polar Coordinates - areas')

fm2_4_7_branch = fm_a2_u4_branch.child_branches.create!(name: 'FM2.4.7', label: 'FM2.4.7 Hyperbolic functions')
fm2_4_7_branch.child_branches.create!(name: 'FM2.4.7a', label: 'FM2.4.7a Hyperbolic functions')
fm2_4_7_branch.child_branches.create!(name: 'FM2.4.7b', label: 'FM2.4.7b Hyperbolic functions - calculus')

fm2_4_8_branch = fm_a2_u4_branch.child_branches.create!(name: 'FM2.4.8', label: 'FM2.4.8 Differential equations')
fm2_4_8_branch.child_branches.create!(name: 'FM2.4.8a', label: 'FM2.4.8a Further 1st order Differential equations')
fm2_4_8_branch.child_branches.create!(name: 'FM2.4.8b', label: 'FM2.4.8b 2nd order Differential equations')
